...
const NOTIF_CONTENT = {
  morning: [
    { title: 'Habio 🌿', body: '今日も、あの場所への一歩。まずは水を一杯から。' },
    { title: 'Habio 🌿', body: '旅先の朝みたいに、少し軽やかに始めてみませんか。' },
    ...
    { title: 'Habio 🌿', body: '少しずつ、整ってきています。おはようございます。' },
    { title: 'Habio 🌱', body: '朝の5分、ただぼーっとするだけでもいい時間です。' },
    { title: 'Habio 🌿', body: 'また行ける自分へ、今日も少しずつ。' },
  ],
  noon: [
    ...
    { title: 'Habio 🌱', body: 'お昼の後、少し外の空気を感じてみてください。午後が変わります。' },
    { title: 'Habio 🌿', body: '水を飲んでいますか？一杯だけでも体が喜びます。' },
    { title: 'Habio 🌿', body: '今日の「できた」、もうあるはずですよ。' },
    { title: 'Habio 🌱', body: '無理しない積み重ねで、ちゃんと大丈夫です。' },
  ...
  evening: [
    ...
    { title: 'Habio 🌿', body: '今日も少し、また行ける自分に近づいています。' },
    ...
    { title: 'Habio 🌱', body: '今日の積み重ね、ちゃんと続いています。' },
  ],
  goodnight: [
    ...
    { title: 'Habio 🌿', body: 'また行きたい場所へ、今日も少し近づいた気がします。おやすみなさい。' },
    { title: 'Habio 🌙', body: '今日もありがとうございました。ゆっくり眠れますように。' },
    { title: 'Habio 🌱', body: '完璧な一日じゃなくても、それで十分です。おやすみなさい。' },
    { title: 'Habio 🌙', body: '明日の朝、少し軽やかに起きられますように。おやすみなさい。' },
  ],
};
